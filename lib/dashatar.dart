...
class DashatarPuzzle extends StatefulWidget {

  const DashatarPuzzle({Key? key}) : super(key: key);

  @override
  createState() => _PuzzleState();
}

class _PuzzleState extends State<DashatarPuzzle> {
  int x = 0;
  int y = 0;
  int init = 1;
  int move = 0;
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage("web/images/dashatar/blue/"+f.value+".png"),
                  fit: BoxFit.cover,
                ),
              ),
            ),
